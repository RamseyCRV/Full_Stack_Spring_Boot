...
public final class InitConstants {
    ...
    public static final String HTML = "signIn";
    public static final String HTML_ERROR = "signUpError";
    ...
    public static final String URL_ERROR_SIGN_UP = "/errorSignUp";
    ...
    public static final String REDIRECT_TO_SIGN_UP_ERROR = "redirect:/errorSignUp";
